...
const CountryCard = ({ item }) => {
    ...
    return (
        <div className={`${darkTheme ? `bg-darkBlue` : `bg-white`} shado-md animate-fade-in transition-shadow shadow hover:shadow-xl cursor-pointer rounded-md mx-auto h-auto w-64 overflow-hidden`}>
            ...
            <div className={`h-1/2 w-full p-4 pb-10`}>
                ...
                <p><span className="font-[500]">Populatoin: </span>{item.population}</p>
